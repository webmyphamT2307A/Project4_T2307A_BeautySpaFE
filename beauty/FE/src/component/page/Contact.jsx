                    ...
                    <div className="col-12">
                        <div className="bg-light rounded p-4 p-sm-5 mt-5">
                            <div className="text-center mx-auto" style={{ maxWidth: 500 }}>
                                <h2 className="display-6 mb-4">Do you have Any Questions?</h2>
                            </div>
                            <form onSubmit={handleSubmit}>
                                <div className="row g-4">
                                    ...
                                    {/* ... các input còn lại ... */}
                                    <div className="col-lg-6">
                                        <input type="text" name="subject" className="form-control py-3" placeholder="Subject" required value={formData.subject} onChange={handleChange} />
                                    </div>
                                    <div className="col-12">
                                        <textarea name="message" className="form-control" rows={5} placeholder="Your Message" required value={formData.message} onChange={handleChange} />
                                    </div>
